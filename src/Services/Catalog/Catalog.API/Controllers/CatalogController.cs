namespace Microsoft.tonisgarden.Services.Catalog.API.Controllers;
...
public class CatalogController : ControllerBase
{
    ...
    [HttpGet("sizes")]
    [ProducesResponseType(typeof(List<CatalogSize>), (int)HttpStatusCode.OK)]
    public Task<List<CatalogSize>> CatalogSizesAsync() =>
        _context.CatalogSizes.ToListAsync();
        ...
        [FromQuery] int pageIndex = 0)
    {
        ...
        if (sizeId > -1)
        {
            query = query.Where(ci => ci.CatalogSizeId == sizeId);
        }
